...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Besides the position of a pacman, I will also return the corners infor-
        # mation, that is I will record whether each corner has been visited.
        corners_info = {corner: False for corner in self.corners}
        # print(corners_info)
        return (self.startingPosition, corners_info)
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Each time I visit a corner, I will put the value to True.
        pos, corners_info = state[0], state[1]
        if pos in self.corners:
            corners_info[pos] = True
        return 4 == sum(corners_info.values())
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            next_corners_info = corners_info.copy()
            if nextPosition in self.corners:
                next_corners_info[nextPosition] = True
            successors.append(((nextPosition, next_corners_info), action, 1))
...
def cornersHeuristic(state, problem):
    ...
    "*** YOUR CODE HERE ***"
    #In this heuristic, I add all the distance between the pacman and all
